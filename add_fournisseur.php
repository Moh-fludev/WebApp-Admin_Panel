	...
	<div class="app-wrapper">
		...
		<div class="app-content pt-3 p-md-3 p-lg-4">
			<div class="container-xl">
				<h1 class="app-page-title">Fournisseurs</h1>
				<hr class="mb-4">
				<div class="row g-4 settings-section">
					<div class="col-12 col-md-4">
						<h3 class="section-title">Ajouter un Fournisseur</h3>
					...
					<div class="col-12 col-md-8">
						<div class="app-card app-card-settings shadow-sm p-4">
							...
							<div class="app-card-body">
								<form class="settings-form" method="POST" action="model/add_fournisseur.php">
									<div class="mb-3">
									...
									<div class="mb-3">
										...
										<input type="text" name="prenom" class="form-control" id="setting-input-2" required>
									</div>
									<div class="mb-3">
