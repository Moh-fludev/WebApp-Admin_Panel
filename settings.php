...
?>
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">			    
			    <h1 class="app-page-title">Dashboard / Settings</h1>
			    <hr class="mb-4">
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                <h3 class="section-title">General</h3>
		                <div class="section-intro">Info Tech settings <a href="index.php">Learn more</a></div>
	                </div>
  ...
  <circle cx="8" cy="4.5" r="1"/>
									    ...
									    <input type="text" class="form-control" id="setting-input-1" value="Info Tech" required>
									</div>
									<div class="mb-3">
									    <label for="setting-input-2" class="form-label">Contact Name</label>
									    <input type="text" class="form-control" id="setting-input-2" value="0657066542" required>
									</div>
								    <div class="mb-3">
									    <label for="setting-input-3" class="form-label">Business Email Address</label>
									    <input type="email" class="form-control" id="setting-input-3" value="Info_tech@gmail.com">
									</div>
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Settings section intro goes here <a href="index.php">Learn more</a></div>
	                </div>
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">
                ...
                <div class="row g-4 settings-section">
	                <div class="col-12 col-md-4">
		                ...
		                <div class="section-intro">Settings section intro goes here. </div>
	                </div>
	                <div class="col-12 col-md-8">
		                <div class="app-card app-card-settings shadow-sm p-4">						    
						    <div class="app-card-body">
