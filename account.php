...
if (isset($_SESSION['usernameAdmin']) and isset($_SESSION['passwordAdmin'])) {
	...
	$db = db_connect();
	$user_info = user_get_one  ($db,$_SESSION['usernameAdmin'],$_SESSION['passwordAdmin'])-> fetch(PDO::FETCH_ASSOC);
    ...
    <div class="app-wrapper">
	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <h1 class="app-page-title">Dashboard / My Account</h1>
                <div class="row gy-4">
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
										    ...
										    <div class="item-data"><img class="profile-image" src="public/images/profiles/user.png" alt=""></div>
									    </div><!--//col-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data"><?php echo$user_info['username_user'] ?></div>
									    </div><!--//col-->
									    <div class="col text-end">
										    <a class="btn-sm app-btn-secondary" href="#">Change</a>
									    </div><!--//col-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data"><?php echo$user_info['email_user'] ?></div>
									    </div><!--//col-->
									    <div class="col text-end">
										    <a class="btn-sm app-btn-secondary" href="#">Change</a>
									    </div><!--//col-->
							    ...
							    <div class="item border-bottom py-3">
								    <div class="row justify-content-between align-items-center">
									    <div class="col-auto">
									        ...
									        <div class="item-data">Dinar Algerien</div>
									    </div><!--//col-->
									    <div class="col text-end">
										    <a class="btn-sm app-btn-secondary" href="#">Change</a>
									    </div><!--//col-->
