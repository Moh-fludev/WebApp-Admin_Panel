...
?>
			...
			<div class="col-auto">
			<h1 class="app-page-title mb-0">Dashboard / Fouenisseurs</h1>
			
			</div>

			</div>
			<!--//row-->
        <div><a href="add_fournisseur.php"><button type="submit" class="btn app-btn-primary">Ajouter Fournisseur</button></a></div>
			...
			<div class="app-card app-card-orders-table shadow-sm mb-5">
						...
						<table class="table app-table-hover mb-0 text-left">
							...
							if($counte>0){
								foreach($list as $fournisseur){
									echo '<tr class="cell">';
									echo '<td class="cell">'.$fournisseur['id_four'].'</td>';
									echo '<td class="cell">'.$fournisseur['nom_four'].'</td>';
									echo '<td class="cell">'.$fournisseur['prenom_four'].'</td>';
									echo '<td class="cell">'.$fournisseur['tel_four'].'</td>';
								?>
								<td>
                <div class="app-utility-item">
                    <a href="update_fournisseur.php?id_four=<?php echo $fournisseur['id_four']?>">
                ...
                <div class="app-utility-item">
                    <a href="model/delete_four.php?id_four=<?php echo $fournisseur['id_four']?>" >
